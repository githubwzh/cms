...
"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+g+";visibility:hidden;' ></div>");g=a(h).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(r+"_"+d.position,r).append(h);f.p._nvtd&&(g>f.p._nvtd[0]&&(a(r+"_"+d.position,r).width(g),f.p._nvtd[0]=g),f.p._nvtd[1]=g);h=g=g=null;this.nav=!0}}}})},navButtonAdd:function(b,d){d=a.extend({caption:"newButton",title:"",buttonicon:"",onClickButton:null,position:"last",cursor:"pointer"},
